...
const projects = [
    { id: 1, title: "Corporate Overview", subtitle: "Strategic Visual Branding", year: "2024", category: "Company Profile", image: "/heroimg.png" },
    { id: 2, title: "Product Explainer", subtitle: "Dynamic Motion Design", year: "2023", category: "Video Animation", image: "/aboutimage.png" },
    { id: 3, title: "E-Commerce Platform", subtitle: "Next-Gen Digital Experience", year: "2024", category: "Website Development", image: "/heroimg.png" },
    { id: 4, title: "Annual Report 2023", subtitle: "Corporate Storytelling", year: "2023", category: "Company Profile", image: "/aboutimage.png" },
    { id: 5, title: "Brand Identity", subtitle: "Visual Communication", year: "2024", category: "Video Animation", image: "/heroimg.png" },
    { id: 6, title: "Dashboard UI", subtitle: "B2B SaaS Interface", year: "2024", category: "Website Development", image: "/aboutimage.png" },
];
    ...
    return (
        <section className="py-24 max-w-[1440px] mx-auto px-4 md:px-12">
            ...
            <div className="text-center mt-16">
                <button className="text-primary px-10 py-4 rounded-full font-semibold transition-all  tracking-wider text-lg cursor-pointer">
                    View All Projects
                </button>
            </div>
        </section>
