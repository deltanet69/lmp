            ...
            <div className="relative z-10 max-w-[1440px] mx-auto px-4 md:px-12 w-full text-center">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-white text-xs font-bold tracking-[0.25em] ">{pillText}</span>
                    </motion.div>

                    {/* H1 Title */}
                    <h1 className="text-5xl md:text-4xl lg:text-[42px] font-black text-white leading-[1.1] tracking-tighter max-w-5xl mx-auto">
                        {highlightWord ? (
                            <>
