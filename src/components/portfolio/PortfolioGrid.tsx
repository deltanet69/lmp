    ...
    return (
        <section className="py-24 max-w-[1440px] mx-auto px-4 md:px-12">
            ...
            {loading ? (
                ...
                <div className="text-center py-24 text-white/40 text-lg">No projects found.</div>
            ) : (
                <>
                    ...
                    {totalPages > 1 && (
                        <div className="flex items-center justify-center gap-3 mt-14">
                            <button
                                ...
                                disabled={page === 1}
                                className="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:bg-primary hover:border-primary hover:text-white transition-all disabled:opacity-30 disabled:cursor-not-allowed"
                            >
                            ...
                            {Array.from({ length: totalPages }, (_, i) => i + 1).map((num) => (
                                <button
                                    ...
                                    className={`w-10 h-10 rounded-full text-sm font-bold transition-all ${page === num
                                        ? "bg-primary text-white border border-primary shadow-[0_0_15px_rgba(226,14,194,0.4)]"
                    ...
                    <p className="text-center text-white/30 text-sm mt-4">
                        Showing {Math.min(paginated.length, PAGE_SIZE)} of {filtered.length} projects
                    </p>
                </>
            )}
        </section>
