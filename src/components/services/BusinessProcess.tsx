            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {processes.map((process, index) => (
                    <motion.div
                        ...
                        whileHover={{ y: -5 }}
                        className="group relative bg-[#1B1830] border border-white/5 rounded-[2rem] p-8 overflow-hidden transition-all duration-500 hover:border-[#E20EC2]/50 hover:shadow-[#E20EC2] rounded-2xl"
                    >
                        {/* Magic Glow Effect Background */}
                        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-[#2E5BFF]/0 to-[#7A0668]/0 group-hover:from-[#E20EC2]/10 group-hover:to-transparent transition-all duration-500 opacity-0 group-hover:opacity-100 pointer-events-none rounded-[2rem]" />
